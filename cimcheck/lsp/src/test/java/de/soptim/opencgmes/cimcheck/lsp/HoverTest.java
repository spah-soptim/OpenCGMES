...
/**
 * Unit tests for the hover-documentation feature: term extraction at cursor position
 * and rdfs:label / rdfs:comment retrieval via {@link SchemaIndex}.
 */
public class HoverTest {
    ...
    public void commentOf_termNotInSchema_returnsEmpty() {
        ...
        Optional<String> comment = index.commentOf(
                NodeFactory.createURI(CIM + "NoSuch"),
