...
This directory contains W3C standard vocabulary documents, vendored so CIMcheck can type-check
`rdf:`, `rdfs:`, `owl:`, and `sh:` terms offline (see `StandardVocabulary`). These files are
**not** part of CIMcheck: they are W3C works, redistributed here under W3C's license, separate
from CIMcheck's own Apache License 2.0.
