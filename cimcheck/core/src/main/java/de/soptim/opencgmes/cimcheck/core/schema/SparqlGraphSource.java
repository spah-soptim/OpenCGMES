 ...
 * in-memory Jena dataset. It exposes only the four operations CIMcheck needs to load a schema from
 * an endpoint and auto-detect which instance graph belongs to which profile:
 *
 * <ul>
