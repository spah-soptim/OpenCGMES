...
import de.soptim.opencgmes.cimcheck.core.InvalidQueryException;
...
public final class SparqlQueryAnalyzer {
   ...
   * {@code urn:x-cimcheck:base/EQ}, which callers can match by prepending this prefix to a relative
   * config key.
   */
