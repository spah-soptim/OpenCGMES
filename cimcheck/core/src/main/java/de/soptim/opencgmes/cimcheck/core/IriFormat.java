 ...
 *
 * <p>Shared by {@link SparqlQueryValidator} and
 * {@link de.soptim.opencgmes.cimcheck.core.shacl.ShaclShapeAnalyzer} so the two validators
 * format profile/term references identically.</p>
 */
public final class IriFormat {
    ...
    /**
     * Shortens an IRI to its last two path/fragment segments — e.g.
     * {@code http://iec.ch/TC57/ns/CIM/CoreEquipment-EU/3.0} becomes
     * {@code CoreEquipment-EU/3.0}. Returns the IRI unchanged when it has no separator.
     */
